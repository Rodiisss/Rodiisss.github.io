...
void main_loop() {
    ...
    glm_translate(view, (vec3){0.0f, -8.0f, -20.0f});
...
int main(void) {
    ...
    char cwd[FILENAME_MAX]; // FILENAME_MAX is a common buffer size constant
    ...
    unsigned char *data = stbi_load("textures/diamond_ore.jpg", &width, &height, &nrChannels, 0);
